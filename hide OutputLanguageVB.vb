    ...
    Protected Class Domain
        ...
        Private Sub addStateConstants()
            ...
            With _oSourceOutput
                ...
                .AppendText("    public Module " & _Name & "_States")
        ...
        Private Sub addEventConstants()
            ...
            With _oSourceOutput
                ...
                .AppendText("    Public Module " & _Name & "_Events")
                    ...
                    If (sTokens(0).Length > 0) Then
                        For Each sId As String In sTokens
                            ...
                            If oParentClass.Tag = VISIBILITY_MARKER Then
                                Exit For
                            Else
                                Debug.WriteLine(oParentClass.Name)
    ...
    Private Class EAClass
        ...
        Public Sub New(ByVal oEAElement As EA.Element, ByRef oDomain As Domain, ByVal oSourceOutput As RichTextBox)
            ...
            Try
                ...
                _oEAElement.Name = CanonicalName(_oEAElement.Name)      ' be sure the class name is in a legal form
                ...
                With _oSourceOutput
                    ...
                    .AppendText("        If Not _bMemberInitialInstancePopulation Then" & vbCrLf)
                    .AppendText("            DeleteSelfFromGlobalHash()" & vbCrLf)
                    .AppendText("            unrelateAll()" & vbCrLf)
                    .AppendText("        End If" & vbCrLf)
                    .AppendText("    End Sub" & vbCrLf)
                    .AppendText(vbCrLf)
                    ...
                    addDehydrate(_oEAElement, oAttributes, oConnectors)

                    addRehydrate(_oEAElement, oAttributes)

                    addRelink(_oEAElement, oConnectors)
                    ...
                    If _bActiveClass Then               ' if this class has a state machine
                        With _oSourceOutput
                            ...
                            If Pigtails.Count > 0 Then
                                .AppendText("            End Select" & vbCrLf)
                            End If
                            .AppendText("            AnnounceStateTransition(bQuiet, ""ST "" & Me.ShortTypeName & "" "" & ArchitecturalGlobals.StateNameString(currentStateAtEntry) & "" --["" & sSelfIcon & EventNameString(oEvent.EventID) & ""]-> "" & ArchitecturalGlobals.StateNameString(_currentState))" & vbCrLf)
                            .AppendText("        End Sub" & vbCrLf)
                            .AppendText(vbCrLf)
                ...
                If (Not bOmit) And (oState.Name.Length > 0) Then
                    With _oSourceOutput
                        If oState.Subtype <> EA_TYPE.SYNCH_STATE Then           ' if this state is NOT an "ignore event" state
                            ...
                            .AppendText("       '________________________________________________________________ Action -- " & CanonicalName(oClass.Name) & ": " & CanonicalName(oState.Name) & " (v" & oState.Version & ")" & vbCrLf & vbCrLf)
        ...
        'Private Sub addDehydrateAttribute(ByVal oClass As EA.Element, ByVal sClassName As String, ByVal hUnique As Hashtable)
        '    With _oSourceOutput
        '        If Not hUnique.Contains(oClass) Then
        '            hUnique.Add(oClass, oClass)
        '            For Each oAttribute As EA.Attribute In oClass.Attributes
        '                .AppendText("                                                           """ & oAttribute.Name & """, o" & sClassName & "." & oAttribute.Name & ", _" & vbCrLf)
        '            Next
        ...
        '                For Each sId As String In sTokens
        '                    Dim oParentClass As EA.Element = _oDomain.EAClass(sId)
        '                    addDehydrateAttribute(oParentClass, sClassName, hUnique)
        '                Next
        '            End If
        '        End If
        '    End With
        ...
        Private Sub addRelatedRelink(ByVal oConnector As EA.Connector, ByVal oClass As EA.Element)
            ...
            With _oSourceOutput
                ...
                If oConnector.Type = "Association" Then
                    ...
                    .AppendText("                        For Each o" & sOtherClassName & " In " & sOtherClassName & "." & sOtherClassName & "s		   " & vbCrLf)
        ...
        Private Sub addRelatedDeletes(ByVal oRelateDeletes As Collection)
            With _oSourceOutput
                .AppendText(vbCrLf)
                .AppendText("        private sub unrelateAll()" & vbCrLf)
                For Each sRelateDeleteString As String In oRelateDeletes
                    .AppendText(sRelateDeleteString & vbCrLf)
                Next
                .AppendText("        end sub" & vbCrLf)
            End With
        End Sub
        ...
        Private Sub addAttributes(ByVal oClass As EA.Element)
            ...
            Try
                With _oSourceOutput
                    ...
                    Dim oDeleteRelates As New Collection
                    For Each oConnector In oClass.Connectors
                        addAssociation(oConnector, oClass, oDeleteRelates)
                    Next
                    addRelatedDeletes(oDeleteRelates)
                End With
            Catch ex As Exception
                Dim oErrorHandler As New sjmErrorHandler(ex)
            End Try
        ...
        Private Sub addAssociation(ByVal oConnector As EA.Connector, ByVal oClass As EA.Element, ByVal oDeleteRelates As Collection)
            Dim sSupplierCardinality As String
            Dim sClientCardinality As String
            Dim sCardinalityComment As String = ""
            Dim sOtherClassName As String
            ...
            Try
                With _oSourceOutput
                    If oConnector.Type = "Association" Then
                        ...
                        Select Case sSupplierCardinality
                            Case "1", "0..1"
                                oDeleteRelates.Add("            _" & oConnector.Name & "_" & sOtherClassName & " = Nothing")
                                ...
                                .AppendText("                Throw New ApplicationException(""Instance '"" & Me.ShortTypeName & ""' was passed a null instance to relate through " & oConnector.Name & """)" & vbCrLf)
                                .AppendText("            End If" & vbCrLf)
                                .AppendText(vbCrLf)
                                ...
                                .AppendText("                Throw New ApplicationException(""Instance '"" & Me.ShortTypeName & ""' is already related through " & oConnector.Name & """)" & vbCrLf)
                                .AppendText("            End If" & vbCrLf)
                                .AppendText(vbCrLf)
                                Select Case sClientCardinality
                                    Case "0..1", "1"
                                        ...
                                        .AppendText("            Else" & vbCrLf)
                                        .AppendText("                Throw New ApplicationException(""Instance '"" & o" & sOtherClassName & ".ShortTypeName & ""' is already related through " & oConnector.Name & """)" & vbCrLf)
                                        .AppendText("            End If" & vbCrLf)
                            ...
                            Case "0..*", "1..*"
                                oDeleteRelates.Add("            _" & oConnector.Name & "_" & sOtherClassName & "s = New List(of " & sOtherClassName & ")")
                                ...
                                .AppendText("            If bAllowOverwrite Then  ' 444" & vbCrLf)
                                .AppendText("                On Error Resume Next            ' ignore a duplicate error" & vbCrLf)
                                ...
                                Select Case sClientCardinality
                                    Case "0..1", "1"
                                        ...
                                        .AppendText("        Public Sub Unrelate_" & oConnector.Name & "_" & sOtherClassName & "(ByVal o" & sOtherClassName & " As " & sOtherClassName & ")" & vbCrLf)
                                        .AppendText("            o" & sOtherClassName & "._" & oConnector.Name & "_" & oClass.Name & " = Nothing" & vbCrLf)
                                        .AppendText("            If _" & oConnector.Name & "_" & sOtherClassName & "s.Contains( o" & sOtherClassName & ") Then" & vbCrLf)
                                        .AppendText("                _" & oConnector.Name & "_" & sOtherClassName & "s.Remove( o" & sOtherClassName & ")" & vbCrLf)
                                        .AppendText("            End If" & vbCrLf)
                                        .AppendText("        End Sub" & vbCrLf)
                                        .AppendText(vbCrLf)

                                    Case "0..*", "1..*"
                                        .AppendText("            o" & sOtherClassName & "." & oConnector.Name & "_" & oClass.Name & "s.Add(Me)   ' 555" & vbCrLf)
                                        .AppendText("            Return me" & vbCrLf)
                                        .AppendText("        End Function" & vbCrLf)
                                        .AppendText(vbCrLf)
