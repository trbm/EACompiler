        ...
        Private Sub addAttributes(ByVal oClass As EA.Element)
            ...
            Try
                With _oSourceOutput
                    ...
                    .AppendText("         Friend Overrides Sub DisplayAttributes()" & vbCrLf)
                    .AppendText("             Try" & vbCrLf)
                    ...
                    .AppendText("         Friend Shared ReadOnly Property " & oClass.Name & "s() As Collection" & vbCrLf)
                    ...
                    For Each oAttribute In oClass.Attributes
                        ...
                        .AppendText("         Friend " & sStaticString & "Property " & ATTRIBUTE_PREFIX & sCanonicalAttributeName & "() As " & sCanonicalType & vbCrLf)
                        .AppendText("             Get" & vbCrLf)
                    ...
                    If oConnector.Type = "Association" Then
                        ...
                        Select Case sSupplierCardinality
                            Case "1", "0..1"
                                ...
                                .AppendText("        Friend _" & oConnector.Name & "_" & sOtherClassName & " As " & sOtherClassName & vbCrLf)
                                Select Case sSupplierCardinality
                                    Case "0..1", "1"
                                        ...
                                        .AppendText("        Friend ReadOnly Property " & oConnector.Name & "_" & sOtherClassName & "() As " & sOtherClassName & "          ' cardinality: " & sSupplierCardinality & vbCrLf)
                                        .AppendText("            Get" & vbCrLf)
                                    ...
                                    Case "0..*", "1..*"
                                        ...
                                        .AppendText("        Friend ReadOnly Property " & oConnector.Name & "_" & sOtherClassName & "s() As Collection          ' cardinality: " & sSupplierCardinality & vbCrLf)
                                        .AppendText("            Get" & vbCrLf)
                                ...
                                .AppendText("        Friend Sub Relate_" & oConnector.Name & "_" & sOtherClassName & "(ByVal o" & sOtherClassName & " As " & sOtherClassName & ")" & vbCrLf)
                                ...
                                Select Case sClientCardinality
                                    Case "0..1", "1"
                                        ...
                                        .AppendText("        Friend Sub Unrelate_" & oConnector.Name & "_" & sOtherClassName & "(ByVal o" & sOtherClassName & " As " & sOtherClassName & ")" & vbCrLf)
                                    ...
                                    Case "0..*", "1..*"
                                        ...
                                        .AppendText("        Friend Sub Unrelate_" & oConnector.Name & "_" & sOtherClassName & "()" & vbCrLf)
                            ...
                            Case "0..*", "1..*"
                                ...
                                .AppendText("        Friend _" & oConnector.Name & "_" & sOtherClassName & "s As New Collection          ' cardinality: " & sSupplierCardinality & vbCrLf)
                                ...
                                .AppendText("        Friend Sub Relate_" & oConnector.Name & "_" & sOtherClassName & "(ByVal o" & sOtherClassName & " As " & sOtherClassName & ")          ' cardinality: " & sSupplierCardinality & vbCrLf)
            ...
            With _oSourceOutput
                For Each oMethod In _oClassElement.Methods
                    ...
                    If Not oMethod.Abstract Then            ' borrowing the 'abstract' designator to indicate server->client events
                        ...
                        If oMethod.ReturnType.Length > 0 Then           ' if there is a return type
                            .AppendText(") As " & oMethod.ReturnType & vbCrLf)
                            .AppendText("       Return " & sDomainPrefix & _oClassElement.Name & "." & oMethod.Name & "(")
                        Else
                            .AppendText(")" & vbCrLf)
                            .AppendText("            " & sDomainPrefix & _oClassElement.Name & "." & oMethod.Name & "(")
                        End If
        ...
        Private Sub addAttributes()
            ...
            With _oSourceOutput
                For Each oAttribute As EA.Attribute In _oClassElement.Attributes
                    ...
                    .AppendText("    Friend " & sStaticString & "Property " & sCanonicalAttributeName & "() As " & sCanonicalType & vbCrLf)
                    .AppendText("        Get" & vbCrLf)
